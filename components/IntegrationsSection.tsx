      ...
      <div className="mt-10 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-6 relative overflow-hidden rounded-3xl p-8 md:p-12"
        ...
        {integrations.map((item, i) => (
          <Animation key={i} variants={fadeUp}>
            <div className=" flex flex-col gap-5 items-center justify-center rounded-xl px-4 py-8 font-bold bg-white text-(--brand-subtext) card hover:shadow-sm transition"
            >
